    ...
    private async loadTile(z: number, x: number, y: number, key: string) {
        ...
        try {
            ...
            if (tile) {
                ...
                // The tiles generated by duckdb-arrowtiles are actually complete Arrow IPC files 
                // which include the ARROW1 magic header and the schema natively! 
                // We do not need to manually stitch the schema.
